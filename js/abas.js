function mostrarconteudo1() {
    ...
    let elemento3 = document.getElementById('content3'); //abafilmes
    elemento3.style.display = 'none';
    let abafilmes = document.getElementById('aba3');
    abafilmes.style.backgroundColor = 'var(--color4)';
}
...
function mostrarconteudo2() {
    ...
    aba3.style.backgroundColor = 'var(--color4)';
}
